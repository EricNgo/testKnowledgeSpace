...
namespace KnowledgeSpace.BackendServer.Controllers
{
    public partial class KnowledgeBaseController 
    {
        ...
        public async Task<IActionResult> PostReport(int knowledgeBaseId, [FromBody] ReportCreateRequest request)
        {
            ...
            {
                return BadRequest(new ApiResponseBadRequest($"Create report failed"));
            }
        }
        ...
        public async Task<IActionResult> PutReport(int reportId, [FromBody] CommentCreateRequest request)
        {
            ...
            return BadRequest(new ApiResponseBadRequest($"Update report failed"));
        }
        ...
        public async Task<IActionResult> DeleteReport(int knowledgeBaseId, int reportId)
        {
            var report = await _context.Reports.FindAsync(reportId);
            if (report == null)
                return BadRequest(new ApiResponseBadRequest($"Cannot found report with id {reportId}"));
            ...
            return BadRequest(new ApiResponseBadRequest($"Delete report failed"));
        }
