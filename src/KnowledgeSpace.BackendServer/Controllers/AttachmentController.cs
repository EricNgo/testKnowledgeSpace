...
namespace KnowledgeSpace.BackendServer.Controllers
{
        ...
        public partial class KnowledgeBaseController
        {
            ...
            public async Task<IActionResult> DeleteAttachment(int attachmentId)
            {
                ...
                if (attachment == null)
                    return BadRequest(new ApiResponseBadRequest($"Cannot found attachment with id {attachmentId}"));
                ...
                return BadRequest(new ApiResponseBadRequest($"Delete attachment failed"));
            }
