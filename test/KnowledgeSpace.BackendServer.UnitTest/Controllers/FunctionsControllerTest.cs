...
namespace KnowledgeSpace.BackendServer.UnitTest.Controllers
{
    public class FunctionsControllerTest
    {
        ...
        {
            var controller = new FunctionController(_context);
        ...
        {
            var usersController = new FunctionController(_context);
        ...
        public async Task PostUser_ValidInput_Failed()
        {
            ...
            var functionsController = new FunctionController(_context);
